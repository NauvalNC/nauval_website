$(document).ready(function()
{
  ...
  var models = 
  [
    {src:"1ss4Q701qejQOOu7aH2PZZhYr_DZ2wXP0"}, // koragi
    ...
    {src:"1YETarxwugNYRr1Z9R5ceRy1x1zw5ZPWH"}, //elusivemalva
  ...
  for (var i = 0; i < col; i++) {
    ...
    for (var j = 0; j < row; j++) {
      ...
      item += "<img class='image-view model_img w-100 shadow-1-strong rounded mb-4' src='" + url + models[index].src + "'/>";
      index++;
    }
    item += "</div>";
  }
